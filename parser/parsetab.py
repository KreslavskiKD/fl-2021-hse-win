...
_lr_productions = [
  ...
  ('expressions -> expression','expressions',1,'p_expressions','parse.py',247),
  ('expressions -> expression expressions','expressions',2,'p_expressions','parse.py',248),
  ('expression -> classdef','expression',1,'p_expression','parse.py',257),
  ('expression -> automaton','expression',1,'p_expression','parse.py',258),
  ('expression -> alphabet','expression',1,'p_expression','parse.py',259),
  ('empty -> <empty>','empty',0,'p_empty','parse.py',265),
  ('alphabet -> DEF ID TYPIZATION CLASSNAME EQUALITY BLOCKSTART enumeration BLOCKEND','alphabet',8,'p_alphabet','parse.py',274),
  ('alphabet -> DEF ID TYPIZATION CLASSNAME EQUALITY CLASSNAME METHOD PARSTART enumeration PAREND','alphabet',10,'p_alphabet','parse.py',275),
  ('alphabet -> DEF ID TYPIZATION CLASSNAME EQUALITY CLASSNAME METHOD BLOCKSTART alphabetdescribebody BLOCKEND','alphabet',10,'p_alphabet','parse.py',276),
  ('enumeration -> term','enumeration',1,'p_enumeration','parse.py',290),
  ('enumeration -> term COMMA enumeration','enumeration',3,'p_enumeration','parse.py',291),
  ('term -> CHAR','term',1,'p_term','parse.py',301),
  ('term -> INT','term',1,'p_term','parse.py',302),
  ('term -> STRING','term',1,'p_term','parse.py',303),
  ('term -> ID','term',1,'p_term','parse.py',304),
  ('term -> CLASSNAME PARSTART enumeration PAREND','term',4,'p_term','parse.py',305),
  ('alphabetdescribebody -> paramsdescribe','alphabetdescribebody',1,'p_alphabetdescribebody','parse.py',315),
  ('alphabetdescribebody -> paramsdescribe COMMA alphabetdescribebody','alphabetdescribebody',3,'p_alphabetdescribebody','parse.py',316),
  ('paramsdescribe -> enumeration FROM ID','paramsdescribe',3,'p_paramsdescribe','parse.py',326),
  ('transitionterm -> CHAR','transitionterm',1,'p_transitionterm','parse.py',331),
  ('transitionterm -> INT','transitionterm',1,'p_transitionterm','parse.py',332),
  ('transitionterm -> STRING','transitionterm',1,'p_transitionterm','parse.py',333),
  ('transitionterm -> CLASSNAME PARSTART enumeration PAREND','transitionterm',4,'p_transitionterm','parse.py',334),
  ('transitionkeyword -> ELSE','transitionkeyword',1,'p_transitionkeyword','parse.py',344),
  ('transitionkeyword -> DEADEND','transitionkeyword',1,'p_transitionkeyword','parse.py',345),
  ('transitionkeyword -> ALPHABET','transitionkeyword',1,'p_transitionkeyword','parse.py',346),
  ('transitionkeyword -> ITSELF','transitionkeyword',1,'p_transitionkeyword','parse.py',347),
  ('transition -> transitionterm ARROW ID','transition',3,'p_transition','parse.py',353),
  ('transition -> transitionkeyword ARROW ID','transition',3,'p_transition','parse.py',354),
  ('transition -> transitionkeyword ARROW transitionkeyword','transition',3,'p_transition','parse.py',355),
  ('automaton -> DEF ID TYPIZATION CLASSNAME EQUALITY CLASSNAME METHOD PARSTART ID PAREND METHOD BLOCKSTART automatondescribebody BLOCKEND','automaton',14,'p_automaton','parse.py',361),
  ('automatondescribebody -> START statedescription states TERMINAL BLOCKSTART termstates BLOCKEND','automatondescribebody',7,'p_automatondescribebody','parse.py',366),
  ('statedescription -> transition statedescription','statedescription',2,'p_statedescription','parse.py',371),
  ('statedescription -> transition','statedescription',1,'p_statedescription','parse.py',372),
  ('states -> states ID statedescription','states',3,'p_states','parse.py',382),
  ('states -> ID statedescription','states',2,'p_states','parse.py',383),
  ('states -> empty','states',1,'p_states','parse.py',384),
  ('termstates -> termstates ID statedescription','termstates',3,'p_termstates','parse.py',396),
  ('termstates -> ID statedescription','termstates',2,'p_termstates','parse.py',397),
  ('termstates -> empty','termstates',1,'p_termstates','parse.py',398),
  ('classdef -> CLASS CLASSNAME PARSTART fields PAREND TYPIZATION CLASSNAME BLOCKSTART classbody BLOCKEND','classdef',10,'p_classdef','parse.py',410),
  ('field -> ID TYPIZATION CLASSNAME','field',3,'p_field','parse.py',415),
  ('field -> ID TYPIZATION CLASSNAME EQUALITY transitionterm','field',5,'p_field','parse.py',416),
  ('fields -> field','fields',1,'p_fields','parse.py',425),
  ('fields -> field COMMA fields','fields',3,'p_fields','parse.py',426),
  ('classbody -> method','classbody',1,'p_classbody','parse.py',435),
  ('classbody -> method classbody','classbody',2,'p_classbody','parse.py',436),
  ('method -> OVERRIDE FUN ID PARSTART fields PAREND TYPIZATION CLASSNAME BLOCKSTART RETURN PARSTART logicoperations PAREND BLOCKEND','method',14,'p_method','parse.py',445),
  ('compareoperation -> ID METHOD COMPAREOPERATOR ID METHOD','compareoperation',5,'p_compareoperation','parse.py',450),
  ('logicoperations -> compareoperation','logicoperations',1,'p_logicoperations','parse.py',455),
  ('logicoperations -> PARSTART logicoperations PAREND','logicoperations',3,'p_logicoperations','parse.py',456),
  ('logicoperations -> logicoperations LOGICOPERATOR PARSTART compareoperation PAREND','logicoperations',5,'p_logicoperations','parse.py',457),
]
